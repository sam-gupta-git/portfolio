    ...
    >
      ...
      <div className="max-w-6xl mx-auto px-6 py-32 relative z-10">
        ...
        <motion.h1
          ...
          className="text-5xl md:text-7xl lg:text-8xl mb-6 tracking-tight font-mono"
        ...
        >
          ...
          <span className="text-[var(--accent-secondary)]">SvelteKit</span>,{" "}
          <span className="text-[var(--accent-secondary)]">JavaScript</span>, and{" "}
          <span className="text-[var(--accent-secondary)]">AWS</span>. Also building other cool stuff ;)       
          </motion.p>
        ...
        >
          <a
            href="#projects"
            className="group inline-flex items-center gap-3 px-6 py-3 bg-[var(--accent)] text-[var(--background)] rounded hover:bg-[var(--accent)]/90 transition-all"
          >
          ...
          <a
            ...
            className="group inline-flex items-center gap-3 px-6 py-3 border border-[var(--border)] text-[var(--foreground)] rounded hover:border-[var(--accent)] hover:text-[var(--accent)] transition-all"
          >
            <svg
              className="w-5 h-5"
              fill="currentColor"
